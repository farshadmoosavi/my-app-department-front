...
export class Department extends Component {
    ...
    //define constructor to define state varaibles :
    constructor(props) {
        super(props);
        this.state = {
            //this array will populated with data from dataprtments data from api:
            departments: [],
            modalTitle: "",
            DepartmentName: "",
            DepartmentId: ""
    ...
    refreshList() {
        //in this function we fetch data and convert it to json and then assign to array(departments)
    ...
    componentDidMount() {   //once the component has mounted, we will call the refreshList
        this.refreshList();
    }
                        ...
                        <div className="modal-content">
                            ...
                            <div className="modal-body">
                                <div className="input-group mb-3">
                                    ...
                                    <input type="text" className="form-control" value={this.state.DepartmentName} onChange={this.changeDepartmentName} />
                                </div>
...
//                     <path
//                       fillRule="evenodd"
//                       d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0
